...
class PTYSessionInfo(BaseModel):
    ...
    command: List[StrictStr] = Field(description="The command running in the PTY session")
    work_dir: StrictStr = Field(description="Working directory of the PTY session", alias="workDir")
    env: Dict[str, Any] = Field(description="Environment variables for the PTY session")
    ...
    __properties: ClassVar[List[str]] = ["id", "command", "workDir", "env", "cols", "rows", "createdAt", "active"]
